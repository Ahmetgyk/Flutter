...
class ResimDatabase{
  String _dbName = 'resimler.db';
  String dbTable = 'resimler';
  int _version = 1;

  String columnId = 'id';
  String columnPlan = 'name';
  String columnResim = 'resim';

  ResimDatabase._privateConstructor();
  static final ResimDatabase instance = ResimDatabase._privateConstructor();
  ...
  Future<List<Map<String, dynamic>>> getList() async {
    ...
    List<Map<String, dynamic>> userMaps = await db.query(dbTable);
    return userMaps;
  }
