    ...
    return SingleChildScrollView(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            SizedBox(height: bosluk,),
            Text("Merhaba Mahmut,", style: TextStyle(color: gr, fontSize: 30, fontWeight: FontWeight.w600,)),
            SizedBox(height: bosluk,),
            Text(isanim?"Plan takvimi;":"Anlık plan;", style: TextStyle(color: gir.withOpacity(0.6), fontSize: 20, fontWeight: FontWeight.w600,)),
            SizedBox(height: bosluk / 3,),
                  ...
                  Stack(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(radius),
                          image: DecorationImage(image: AssetImage("server/ayasofya.jpg"), fit: BoxFit.cover),
                        ),
                      ),
                      Positioned(
                        bottom: 10, right: 10,
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            children: [
                              ...
                              _dbanim.value ==10 ? SingleChildScrollView(child: Column(children: eventwidget,)) : Container(),
                            ],
                          ),
                        )
                      );
